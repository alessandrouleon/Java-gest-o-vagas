...
public class CompanyValidationMessages {
    public static final String COMPANY_EXISTS = "Esta empresa ja existe";
    ...
    public static final String NOT_EMPTY_WEBSIT = "Campo [site web] é obrigatório";
